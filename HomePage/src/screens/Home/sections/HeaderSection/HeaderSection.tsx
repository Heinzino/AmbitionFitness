  ...
  return (
    <section className="inline-flex items-center gap-[50px] absolute top-[1336px] left-[calc(50.00%_-_600px)]">
      ...
      <div className="flex flex-col w-[631px] items-start gap-[30px] relative">
        ...
        <button
          className="inline-flex h-14 items-center justify-center gap-2.5 px-[35px] py-[15px] relative rounded-[1000px] border border-solid border-variable-collection-coloryellow bg-transparent cursor-pointer transition-all hover:bg-variable-collection-coloryellow hover:text-variable-collection-colorpriamry focus:outline-none focus:ring-2 focus:ring-variable-collection-coloryellow focus:ring-offset-2 focus:ring-offset-variable-collection-colorpriamry"
          type="button"
