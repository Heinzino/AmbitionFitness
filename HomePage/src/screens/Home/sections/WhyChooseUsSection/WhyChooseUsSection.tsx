  ...
  const services: ServiceItem[] = [
    {
      ...
      description:
        "Full Truckload and Less Than Truckload freight transport options available for seamless logistics management.",
    ...
    },
    {
      ...
      title: "Memberships",
      description:
        "Specialized services for time-sensitive shipments with utmost priority and on-time delivery guarantee.",
    ...
    },
    {
      ...
      description:
        "Efficient warehousing, containers, and owner operators for streamlined logistics operations.",
          ...
          >
            ...
            <div className="flex flex-col items-start gap-[11.29px] p-5 relative flex-1 grow">
              <div className="flex flex-col items-start gap-[15px] relative self-stretch w-full flex-[0_0_auto]">
                ...
                <button
                  className="inline-flex h-14 items-center justify-center gap-2.5 px-[35px] py-[15px] relative rounded-[1000px] border border-solid border-variable-collection-coloryellow hover:bg-variable-collection-coloryellow hover:text-variable-collection-colorpriamry transition-colors duration-300"
