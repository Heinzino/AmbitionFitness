...
const socialMediaLinks = [
  {
    ...
    alt: "Instagram",
    iconStyle:
      "absolute w-[83.33%] h-[83.33%] top-[-88552.22%] left-[-38687.78%]",
  },
  {
    id: "twitter",
    icon: "/img/image.svg",
    alt: "Twitter",
    iconStyle:
      "absolute w-[100.00%] h-[70.02%] top-[-88545.56%] left-[-38921.11%]",
  },
  {
    id: "facebook",
    ...
    alt: "Facebook",
    iconStyle:
      "relative w-[18.95px] h-[18.95px] mt-[-16772.00px] ml-[-7409.26px]",
  },
];
      ...
      <div className="flex flex-col items-start gap-20 relative self-stretch w-full flex-[0_0_auto]">
        <div className="flex items-start gap-[31px] relative self-stretch w-full flex-[0_0_auto]">
          ...
          >
            ...
            <ul className="flex flex-col items-start justify-center gap-1 relative self-stretch w-full flex-[0_0_auto] opacity-80 list-none">
          ...
          >
            ...
            <ul className="flex flex-col items-start justify-center gap-1 relative self-stretch w-full flex-[0_0_auto] opacity-80 list-none">
              {companyData.map((item, index) => (
                <li
                  key={index}
                  className={`${index === 0 ? "mt-[-1.00px]" : ""} relative w-fit [font-family:'Montserrat',Helvetica] font-normal text-white text-sm tracking-[0] leading-[26px] whitespace-nowrap`}
                >
                  <a
                    href="#"
                    className="hover:text-variable-collection-coloryellow transition-colors"
        ...
        <hr
          className="relative self-stretch w-full h-px mt-[-16237.89px] ml-[-6244.00px] object-cover border-0 bg-white opacity-20"
          aria-hidden="true"
        />
      </div>
