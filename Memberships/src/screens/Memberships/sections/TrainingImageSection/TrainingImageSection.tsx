...
export const TrainingImageSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-[1010px] items-center justify-center gap-10 p-[60px] absolute top-[2936px] left-[calc(50.00%_-_505px)] bg-variable-collection-coloryellow rounded-xl">
