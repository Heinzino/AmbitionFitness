...
export const HeroSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full lg:w-[783px] items-start justify-center gap-6 md:gap-10 px-4 md:px-8 lg:px-0 py-12 md:py-16 lg:py-0 relative lg:absolute lg:top-[272px] lg:left-[357px] z-10">
