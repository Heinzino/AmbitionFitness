...
export const GetStartedSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col w-[1010px] items-center justify-center gap-10 p-[60px] absolute top-[4474px] left-[455px] bg-variable-collection-coloryellow rounded-xl">
      ...
      <button
        className="inline-flex h-14 items-center justify-center gap-[13px] px-6 py-5 relative bg-variable-collection-colorpriamry rounded-xl overflow-hidden cursor-pointer transition-opacity hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-variable-collection-colorpriamry focus:ring-offset-2"
