...
export const FacilityFeaturesSection = (): JSX.Element => {
  const servicesData = [
    "Personal Training",
    "Group Classes",
    "Online Training",
  ...
  const socialLinks = [
    {
      ...
      alt: "Subtract",
      className:
        "absolute w-[83.33%] h-[83.33%] top-[-96537.49%] left-[-64232.22%]",
    },
    {
      icon: "/img/image.svg",
      alt: "Subtract",
      className:
        "absolute w-[100.00%] h-[70.02%] top-[-96530.83%] left-[-64465.56%]",
    },
    {
      icon: "/img/facebook.png",
      alt: "Facebook",
      className:
        "relative w-[18.95px] h-[18.95px] mt-[-18285.00px] ml-[-12249.26px]",
    },
  ];
  ...
  return (
    <footer className="flex flex-col w-[1920px] items-start justify-center gap-[30px] pt-[110px] pb-[30px] px-[360px] absolute left-[calc(50.00%_-_960px)] bottom-[-135px]">
      <div className="flex flex-col items-start gap-20 relative self-stretch w-full flex-[0_0_auto]">
        ...
        <hr
          className="relative self-stretch w-full h-px mt-[-17750.89px] ml-[-11084.00px] object-cover border-0 bg-white opacity-20"
          aria-hidden="true"
        />
      </div>
