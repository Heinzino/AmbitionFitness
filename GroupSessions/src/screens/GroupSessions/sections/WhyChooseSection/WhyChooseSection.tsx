...
export const WhyChooseSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-[1010px] items-center justify-center gap-10 p-[60px] absolute top-[3369px] left-[455px] bg-variable-collection-coloryellow rounded-xl">
